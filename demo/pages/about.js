...
export default createContainerComponent(() => {
  ...
  return /*html*/`
    <page-container>
      ...
      <p>Putting aside the class "extends" syntax, defining components <i>functionally</i> with Thunderous allows us to reduce unneccessary repitition, track component state, easily assign events to the DOM, and more, all while avoiding some of the issues with inheritance.</p>
    </page-container>
  `
})
